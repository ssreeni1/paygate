...
export function loadPrivateKey() {
    ...
    if (cmd) {
        try {
            ...
            throw new Error(`PAYGATE_PRIVATE_KEY_CMD failed: ${err instanceof Error ? err.message : String(err)}`);
        }
    }
    ...
    throw new Error('No private key configured. Set PAYGATE_PRIVATE_KEY or PAYGATE_PRIVATE_KEY_CMD.');
}
